...
import com.elf.core.filter.WebServiceAuthFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setUnauthorizedUrl("/page/common_404");
        /*定义shiro过滤器,例如实现自定义的FormAuthenticationFilter，需要继承FormAuthenticationFilter */
        Map<String, Filter> filtersMap = new LinkedHashMap<>();
        filtersMap.put("authws", new WebServiceAuthFilter());
        ...
        filterChainDefinitionMap.put("/ws/**", "authws");
