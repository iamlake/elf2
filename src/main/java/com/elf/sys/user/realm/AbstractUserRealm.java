package com.elf.sys.user.realm;//package com.elf.sys.user.realm;
//
...
//        //从数据库中获取当前登录用户的详细信息
//        User userInfo = userMapper.selectByAccount(currentLoginName);
//        if (null != userInfo) {
...
//        final User user = userMapper.selectByAccount(String.valueOf(authenticationToken.getPrincipal()));
//        if (user == null) {
//            //找不到账号
