...
public class BusiRoleController extends BaseController {
    ...
    @RequestMapping(value = "/getUserWithUnitsByRoleId", method = {RequestMethod.POST, RequestMethod.GET})
    @ResponseBody
    public Result getUserWithUnitsByRoleId(String busiRoleId) {
        List<User> UserList = busiRoleService.getUserWithUnitsByRoleId(busiRoleId);
    ...
    @RequestMapping(value = "/getAllBusiRoles", method = {RequestMethod.POST, RequestMethod.GET})
    @ResponseBody
    public Result getAllBusiRoles() {
        List<SysSecBusiRole> BusiRoleList = busiRoleService.getAllBusiRoles();
        QueryResult<SysSecBusiRole> result = new QueryResult<SysSecBusiRole>();
        result.setCode(Global.RESULT_STAUTS_SUCCESS);
        result.setData(BusiRoleList);
        result.setCount(BusiRoleList.size());
