    ...
    <body class="loginBody">
        <form class="layui-form loginform">
            <div class="login_face">
                <img src="${basePath}/static/assets/images/userhead/icelake.jpg" class="userAvatar">
            </div>
            ...
            <div class="layui-form-item input-item" id="imgCode">
                ...
                <input type="text" name="kaptcha" placeholder="请输入验证码" autocomplete="off" class="layui-input">
                <img src="${basePath}/api/kaptcha.jpg" title="看不清?点击换一张" class="kaptchaImage" data-type="changeImage" />
            </div>
