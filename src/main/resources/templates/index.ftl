...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;">
                        <img src="${basePath}${(user_session.currentUser.userHead)!''}" class="layui-nav-img userAvatar" width="35" height="35">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${basePath}${(user_session.currentUser.userHead)!''}" class="userAvatar"></a>
            <p>你好！<span class="userName">${(user_session.currentUser.fullname)!''}</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
