        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children != undefined && data[i].children.length > 0) {
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    _href = elf.checkUrl(data[i].children[j].href) ? data[i].children[j].href : basePath + data[i].children[j].href;
                ...
                _href = elf.checkUrl(data[i].href) ? data[i].href : basePath + data[i].href;
